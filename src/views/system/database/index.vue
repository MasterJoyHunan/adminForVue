<template>
    <div class="app-container">
        <p style="border-bottom: 1px solid #000; padding: 10px;">数据库列表</p>
        <div class="filter-container">
            <el-button type="primary" plain class="filter-item" @click="backSql()">备份数据库</el-button>
            <el-button type="danger" plain class="filter-item" @click="initSql()">系统初始化</el-button>
        </div>
        <el-table
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="warning" @click="restore(scope.row)">还原</el-button>
                    <el-button size="mini" type="danger" @click="deleteSql(scope.$index, scope.row)">删除</el-button>
