<template>
    <div class="app-container">
        <el-form label-width="180px" status-icon :rules="formRules" ref="loginForm" :model="formValue" @submit.native.prevent>
            <el-form-item label="管理员账号" prop="user_name">
                <el-input name="name" v-model="formValue.user_name" style="width: 280px" :disabled="user_name_readonly"></el-input>
            </el-form-item>
            <el-form-item label="设置角色" prop="role_id">
                <el-select v-model="formValue.role_id" style="width: 280px" placeholder="请选择">
                    <el-option v-for="(role,i) in roles" :key="i" :label="role.role_name" :value="role.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="设置密码" prop="password">
                <el-input v-model="formValue.password" style="width: 280px" type="password" :placeholder="passwordPlaceholder"></el-input>
            </el-form-item>
            <el-form-item label="真实姓名" prop="real_name">
                <el-input v-model="formValue.real_name" style="width: 280px"></el-input>
            </el-form-item>
            <el-form-item label="是否启用">
                <el-radio-group v-model="formValue.status">
                    <el-radio border v-for="(la, i) in status" :key="i" :label="i">{{la}}</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="onSubmit()">立即创建</el-button>
                <el-button @click="resetForm" v-if="!user_name_readonly">重置</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
