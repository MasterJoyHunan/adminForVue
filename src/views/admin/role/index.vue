<template>
    <div class="app-container">
        ...
        <div class="filter-container">
            <el-button type="primary" plain class="filter-item" @click="addRole()">添加角色</el-button>
        </div>
        <el-table
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="success" v-if="scope.row.id != 1"
                               @click="handleAuth(scope.$index, scope.row)">分配权限
                    </el-button>
                    <el-button size="mini" type="danger" v-if="scope.row.id != 1"
        ...
        <el-dialog :visible.sync="showDialog" :title="title" width="30%">
            <el-form :model="form" status-icon label-width="80px" :rules="formRole" ref="roleForm"
        ...
        <el-dialog :visible.sync="showDialogDistribution" title="分配权限" width="30%" class="my-dialog">
            <el-tree
                    ref="tree"
                    :data="tree"
                    show-checkbox
            ...
            <el-button type="primary" @click="giveAccess()" style="float: right">确定分配</el-button>
        </el-dialog>
    </div>
</template>
